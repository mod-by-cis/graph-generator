...
- @lastmodified 2025-06-12T14:06:10.536Z
...
| `./.github/workflows/docs-build.yml`        | `2025-06-12T13:33:51.178Z`             |
| `./deno.jsonc`                              | `2025-06-12T13:57:47.083Z`             |
| `./tasks/docs-build.ts`                     | `2025-06-12T13:04:37.531Z`             |
| `./tasks/docs-serve.ts`                     | `2025-06-12T13:02:17.500Z`             |
| **Struktura Aplikacji (`/docs`)**           |                                        |
| `./docs/index.html`                         | `2025-06-12T13:08:51.934Z`             |
| `./docs/css/reset.css`                      | `2025-06-12T13:10:25.270Z`             |
| `./docs/css/main.css`                       | `2025-06-12T13:12:07.028Z`             |
| `./docs/css/ui/AccordionFields.css`         | `2025-06-12T13:13:11.138Z`             |
| **Kod Źródłowy (`/docs/dev`)**              |                                        |
| `./docs/dev/main.tsx`                       | `2025-06-12T13:15:20.370Z`             |
| `./docs/dev/style/types.ts`                 | `2025-06-12T13:16:36.109Z`             |
| `./docs/dev/core/state-accordion.ts`        | `2025-06-12T13:19:01.961Z`             |
| **Komponenty UI (`/docs/dev/ui`)**          |                                        |
| `./docs/dev/ui/AccordionField.tsx`          | `2025-06-12T13:20:17.608Z`             |
| `./docs/dev/ui/AccordionFields.tsx`         | `2025-06-12T13:21:12.598Z`             |
| `./docs/dev/ui/AccordionFieldsPilot.tsx`    | `2025-06-12T13:23:07.062Z`             |
| **Komponenty Stron (`/docs/dev/pages`)**    |                                        |
| `./docs/dev/pages/AboutThis.tsx`            | `2025-06-12T13:28:31.401Z`             |
| `./docs/dev/pages/DotInsert.tsx`            | `2025-06-12T13:29:20.880Z`             |
| `./docs/dev/pages/DotRender.tsx`            | `2025-06-12T13:29:58.528Z`             |
| `./docs/dev/pages/DotWriter.tsx`            | `2025-06-12T13:30:39.314Z`             |
| `./docs/dev/pages/EduDot.tsx`               | `2025-06-12T13:31:24.942Z`             |
| `./docs/dev/pages/EduGraphs.tsx`            | `2025-06-12T13:31:53.000Z`             |
...
// @author https://github.com/j-Cis
// 
// @lastmodified 2025-06-12T13:57:47.083Z
 ...
 * @author https://github.com/j-Cis
 * 
 * @lastmodified 2025-06-12T13:08:51.934Z
 ...
 * @author https://github.com/j-Cis
 * 
 * @lastmodified 2025-06-12T13:10:25.270Z
 ...
 * @author https://github.com/j-Cis
 * 
 * @lastmodified 2025-06-12T13:13:11.138Z
 ...
 * @author https://github.com/j-Cis
 * 
 * @lastmodified 2025-06-12T13:12:07.028Z
